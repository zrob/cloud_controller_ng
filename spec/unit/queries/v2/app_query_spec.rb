  ...
  RSpec.describe AppQuery do
    ...
    describe 'filtering by organization_guid' do
      it 'works for equals' do
        expected_app = VCAP::CloudController::Process.make
        VCAP::CloudController::Process.make

        results = AppQuery.filtered_dataset_from_query_params(
          VCAP::CloudController::Process,
          VCAP::CloudController::Process.dataset,
      ...
      it 'works for IN' do
        expected_app1 = VCAP::CloudController::Process.make
        expected_app2 = VCAP::CloudController::Process.make
        VCAP::CloudController::Process.make
