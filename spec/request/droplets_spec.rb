...
RSpec.describe 'Droplets' do
  ...
  describe 'GET /v3/droplets' do
    ...
    before do
      droplet1.buildpack_lifecycle_data.update(buildpack_identifier: buildpack.name, stack: 'stack-1')
      droplet2.buildpack_lifecycle_data.update(buildpack_identifier: 'http://buildpack.git.url.com', stack: 'stack-2')
    end
  ...
  describe 'POST /v3/droplets/:guid/copy' do
    ...
    before do
      og_droplet.buildpack_lifecycle_data.update(buildpack_identifier: 'http://buildpack.git.url.com', stack: 'stack-name')
    end
