...
module VCAP::CloudController
  class AppCrashedController < RestController::BaseController
    ...
    def crashed(process_guid)
      ...
      Repositories::ProcessEventRepository.new(nil).record_crash(process, crash_payload)
      Repositories::AppEventRepository.new(nil).create_app_exit_event(process, crash_payload)
    end
