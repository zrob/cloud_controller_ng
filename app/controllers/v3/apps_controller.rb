...
class AppsV3Controller < ApplicationController
  ...
  def create
    ...
    app = AppCreate.new(audit_user_info).create(message, lifecycle)
  ...
  def update
    ...
    app = AppUpdate.new(audit_user_info).update(app, message, lifecycle)
  ...
  def destroy
    ...
    AppDelete.new(audit_user_info).delete(app)
  ...
  def start
    ...
    AppStart.start(app: app, user_info: audit_user_info)
  ...
  def stop
    ...
    AppStop.stop(app: app, user_info: audit_user_info)
  ...
  def assign_current_droplet
    ...
    SetCurrentDroplet.new(audit_user_info).update_to(app, droplet)
