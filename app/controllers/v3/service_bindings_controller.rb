...
class ServiceBindingsController < ApplicationController
  ...
  def create
    ...
    begin
      service_binding = ServiceBindingCreate.new(audit_user_info).create(app, service_instance, message, volume_services_enabled?)
  ...
  def destroy
    ...
    ServiceBindingDelete.new(audit_user_info).single_delete_sync(binding)
