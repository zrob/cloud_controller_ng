...
class ProcessesController < ApplicationController
  ...
  def update
    ...
    ProcessUpdate.new(audit_user_info).update(process, message)
  ...
  def terminate
    ...
    ProcessTerminate.new(audit_user_info, process, params[:index].to_i).terminate
  ...
  def scale
    ...
    ProcessScale.new(audit_user_info, process, message).scale
