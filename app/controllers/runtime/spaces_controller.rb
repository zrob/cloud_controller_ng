...
module VCAP::CloudController
  class SpacesController < RestController::ModelController
    ...
    def delete(guid)
      ...
      @space_event_repository.record_space_delete_request(space, recursive_delete?)

      delete_action = SpaceDelete.new(audit_user_info, @services_event_repository)
    ...
    def after_create(space)
      @space_event_repository.record_space_create(space, request_attrs)
    end

    def after_update(space)
      @space_event_repository.record_space_update(space, request_attrs)
    end
