...
module VCAP::CloudController
  class AppModel < Sequel::Model(:apps)
    ...
    one_to_many :processes, class: 'VCAP::CloudController::Process', key: :app_guid, primary_key: :guid
    ...
    one_to_one :web_process, class: 'VCAP::CloudController::Process', key: :app_guid, primary_key: :guid, conditions: { type: 'web' }
