module VCAP::CloudController
  class Space < Sequel::Model
    ...
    one_to_many :processes, class: 'VCAP::CloudController::Process', dataset: -> { Process.filter(app: app_models) }

    many_through_many :apps, [
      [:spaces, :id, :guid],
      [:apps, :space_guid, :guid]
    ], class: 'VCAP::CloudController::Process', right_primary_key: :app_guid, conditions: { type: 'web' }
