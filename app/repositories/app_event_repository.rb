  ...
  module Repositories
    class AppEventRepository
      ...
      def record_app_update(app, space, user_audit_info, request_attrs)
        ...
        actor    = { name: user_audit_info.user_email, guid: user_audit_info.user_guid, type: 'user' }
      ...
      def record_map_route(app, route, user_audit_info, route_mapping: nil)
        actor_hash = user_audit_info.user_guid.nil? ? SYSTEM_ACTOR_HASH : { guid: user_audit_info.user_guid, name: user_audit_info.user_email, type: 'user' }
      ...
      def record_app_restage(app, user_audit_info)
        actor_hash = { name: user_audit_info.user_email, guid: user_audit_info.user_guid, type: 'user' }
