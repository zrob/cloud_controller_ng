    ...
    class AppUsageEventRepository
      ...
      def purge_and_reseed_started_apps!
        ...
        column_map = {
          ...
          guid:                               "#{Process.table_name}__guid".to_sym,
          app_guid:                           "#{Process.table_name}__guid".to_sym,
          state:                              "#{Process.table_name}__state".to_sym,
          previous_state:                     "#{Process.table_name}__state".to_sym,
          ...
          previous_package_state:             'UNKNOWN',
          instance_count:                     "#{Process.table_name}__instances".to_sym,
          previous_instance_count:            "#{Process.table_name}__instances".to_sym,
          memory_in_mb_per_instance:          "#{Process.table_name}__memory".to_sym,
          previous_memory_in_mb_per_instance: "#{Process.table_name}__memory".to_sym,
        ...
        usage_query =
          ...
          where("#{Process.table_name}__state".to_sym => 'STARTED').
